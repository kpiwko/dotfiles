---
description: Explicit opt-in LiteMaaS implementation specialist with the same capabilities and workflow as implement-local.
mode: subagent
model: litemaas/Qwen3.8-27B-NT
permission:
  bash:
    "*": ask
    git *: deny
